  ...
  <section class="comment-create">
    ...
    >
      <el-form-item label="昵称" prop="nickname">
        <el-input v-model="ruleForm.nickname" placeholder="请输入您的昵称"></el-input>
      </el-form-item>
      <el-form-item label="评论" prop="content">
        <el-input type="textarea" v-model="ruleForm.content" placeholder="请输入评论内容"></el-input>
      </el-form-item>
      <el-form-item>
        ...
        >{{comment_type==='comment'?'评论':'回复'}}</el-button>
      </el-form-item>
    </el-form>
  </section>
</template>
